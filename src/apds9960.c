...
int apds9960init(void)
{
    ...
    // Enable gesture engine only
    if (!i2c2_write(APDS9960_PPULSE, DEFAULT_GESTURE_PPULSE)) {
        return false;
    }

    if (!i2c2_write(APDS9960_GCONF1, DEFAULT_GCONF1)) {
        return false;
    }
    ...
    if (!i2c2_write(APDS9960_GPULSE, DEFAULT_GPULSE)) {
        return false;
    }

    if (!i2c2_write(APDS9960_GCONF3, DEFAULT_GCONF3)) {
        return false;
    }
    ...
    if (!setGestureIntEnable(0)) {  // disable interrupts
        return false;
    }
...
int setMode(uint8_t mode, uint8_t enable)
{
    ...
    if( !i2c2_write(APDS9960_ENABLE, reg_val) ) {
        return false;
    }
...
uint8_t getMode(void)
{
  uint8_t enable_value;
    ...
    /* Read current ENABLE register */
    if( !i2c2_read(APDS9960_ENABLE,&enable_value,1) ) 
    {
        return ERROR;
    }
...
int setLEDDrive(uint8_t drive)
{
    ...
    if( !i2c2_read(APDS9960_CONTROL, &val,1) ) {
        return false;
    }
    ...
    if( !i2c2_write(APDS9960_CONTROL, val) ) {
        return false;
    }
...
{
    if( !i2c2_write(APDS9960_PILT, threshold) ) {
        return false;
    }
...
{
    if( !i2c2_write(APDS9960_PIHT, threshold) ) {
        return false;
    }
...
int setLightIntLowThreshold(uint16_t threshold)
{
    ...
    /* Write low byte */
    if( !i2c2_write(APDS9960_AILTL, val_low) ) {
        return false;
    }
    
    /* Write high byte */
    if( !i2c2_write(APDS9960_AILTH, val_high) ) {
        return false;
    }
...
int setLightIntHighThreshold(uint16_t threshold)
{
    ...
    /* Write low byte */
    if( !i2c2_write(APDS9960_AIHTL, val_low) ) {
        return false;
    }
    
    /* Write high byte */
    if( !i2c2_write(APDS9960_AIHTH, val_high) ) {
        return false;
    }
...
int setGestureIntEnable(uint8_t enable)
{
    ...
    if( !i2c2_read(APDS9960_GCONF4, &val,1) ) {
        return false;
    }
    ...
    if( !i2c2_write(APDS9960_GCONF4, val) ) {
        return false;
    }
...
int setGestureWaitTime(uint8_t time)
{
    ...
    if( !i2c2_read(APDS9960_GCONF2, &val,1) ) {
        return false;
    }
    ...
    if( !i2c2_write(APDS9960_GCONF2, val) ) {
        return false;
    }
...
{
    if( !i2c2_write(APDS9960_GEXTH, threshold) ) {
        return false;
    }
...
{
    if( !i2c2_write(APDS9960_GPENTH, threshold) ) {
        return false;
    }
...
int enableGestureSensor(int interrupts)
{
    ...
    */
    ...
    if( !i2c2_write(APDS9960_WTIME, 0xFF) ) {
        return false;
    }
    if( !i2c2_write(APDS9960_PPULSE, DEFAULT_GESTURE_PPULSE) ) {
        return false;
...
int setLEDBoost(uint8_t boost)
{
    ...
    if( !i2c2_read(APDS9960_CONFIG2, &val,1) ) {
        return false;
    }
    ...
    if( !i2c2_write(APDS9960_CONFIG2, val) ) {
        return false;
    }
...
int isGestureAvailable(void)
{
    ...
    if( !i2c2_read(APDS9960_GSTATUS, &val,1) ) {
        return ERROR;
    }
...
int readGesture(void)
{
    ...
    while(1) {
        ...
        if( !i2c2_read(APDS9960_GSTATUS, &gstatus,1) ) {
            return ERROR;
        }
        ...
        if( (gstatus & APDS9960_GVALID) == APDS9960_GVALID ) {
            ...
            if( !i2c2_read(APDS9960_GFLVL, &fifo_level,1) ) {
                return ERROR;
            }
